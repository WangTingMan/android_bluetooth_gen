...
inline const std::string& EventEnum_Name(T enum_t_value) {
  ...
  return EventEnum_Name(static_cast<EventEnum>(enum_t_value));
}
bool EventEnum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EventEnum* value);
...
inline const std::string& BleMetaEventEnum_Name(T enum_t_value) {
  ...
  return BleMetaEventEnum_Name(static_cast<BleMetaEventEnum>(enum_t_value));
}
bool BleMetaEventEnum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BleMetaEventEnum* value);
enum StatusEnum : int {
  STATUS_UNKNOWN = 4095,
  STATUS_SUCCESS = 0,
...
inline const std::string& StatusEnum_Name(T enum_t_value) {
  ...
  return StatusEnum_Name(static_cast<StatusEnum>(enum_t_value));
}
...
inline const std::string& BqrIdEnum_Name(T enum_t_value) {
  ...
  return BqrIdEnum_Name(static_cast<BqrIdEnum>(enum_t_value));
}
bool BqrIdEnum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BqrIdEnum* value);
...
inline const std::string& BqrPacketTypeEnum_Name(T enum_t_value) {
  ...
  return BqrPacketTypeEnum_Name(static_cast<BqrPacketTypeEnum>(enum_t_value));
}
bool BqrPacketTypeEnum_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BqrPacketTypeEnum* value);
// ===================================================================
