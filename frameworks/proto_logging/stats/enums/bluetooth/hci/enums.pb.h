...
#ifndef GOOGLE_PROTOBUF_INCLUDED_frameworks_2fproto_5flogging_2fstats_2fenums_2fbluetooth_2fhci_2fenums_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_frameworks_2fproto_5flogging_2fstats_2fenums_2fbluetooth_2fhci_2fenums_2eproto_2epb_2eh
...
constexpr CommandEnum CommandEnum_MIN = static_cast<CommandEnum>(1025);
constexpr CommandEnum CommandEnum_MAX = static_cast<CommandEnum>(1048575);
constexpr int CommandEnum_ARRAYSIZE = 1048575 + 1;
...
extern const uint32_t EventEnum_internal_data_[];
constexpr EventEnum EventEnum_MIN = static_cast<EventEnum>(1);
constexpr EventEnum EventEnum_MAX = static_cast<EventEnum>(4095);
constexpr int EventEnum_ARRAYSIZE = 4095 + 1;
const std::string& EventEnum_Name(EventEnum value);
template <typename T>
const std::string& EventEnum_Name(T value) {
  static_assert(std::is_same<T, EventEnum>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to EventEnum_Name().");
  return EventEnum_Name(static_cast<EventEnum>(value));
}
const std::string& EventEnum_Name(EventEnum value);
...
extern const uint32_t BleMetaEventEnum_internal_data_[];
constexpr BleMetaEventEnum BleMetaEventEnum_MIN = static_cast<BleMetaEventEnum>(1);
constexpr BleMetaEventEnum BleMetaEventEnum_MAX = static_cast<BleMetaEventEnum>(4095);
constexpr int BleMetaEventEnum_ARRAYSIZE = 4095 + 1;
const std::string& BleMetaEventEnum_Name(BleMetaEventEnum value);
template <typename T>
const std::string& BleMetaEventEnum_Name(T value) {
  static_assert(std::is_same<T, BleMetaEventEnum>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to BleMetaEventEnum_Name().");
  return BleMetaEventEnum_Name(static_cast<BleMetaEventEnum>(value));
}
const std::string& BleMetaEventEnum_Name(BleMetaEventEnum value);
...
enum StatusEnum : int {
  ...
  STATUS_INSUFFICIENT_SECURITY = 47,
...
constexpr StatusEnum StatusEnum_MAX = static_cast<StatusEnum>(4095);
constexpr int StatusEnum_ARRAYSIZE = 4095 + 1;
...
enum BqrIdEnum : int {
  ...
  BQR_ID_ROOT_INFLAMMATION = 5,
  BQR_ID_ENERGY_MONITOR = 6,
  BQR_ID_LE_AUDIO_CHOPPY = 7,
  BQR_ID_CONNECT_FAIL = 8,
  BQR_ID_RF_STATS = 9,
  BQR_ID_VENDOR_SPECIFIC_QUALITY = 16,
  BQR_ID_LMP_LL_MESSAGE_TRACE = 17,
  BQR_ID_BT_SCHEDULING_TRACE = 18,
  BQR_ID_CONTROLLER_DBG_INFO = 19,
  BQR_ID_VENDOR_SPECIFIC_TRACE = 32,
};

bool BqrIdEnum_IsValid(int value);
extern const uint32_t BqrIdEnum_internal_data_[];
constexpr BqrIdEnum BqrIdEnum_MIN = static_cast<BqrIdEnum>(0);
constexpr BqrIdEnum BqrIdEnum_MAX = static_cast<BqrIdEnum>(32);
constexpr int BqrIdEnum_ARRAYSIZE = 32 + 1;
const std::string& BqrIdEnum_Name(BqrIdEnum value);
template <typename T>
const std::string& BqrIdEnum_Name(T value) {
  static_assert(std::is_same<T, BqrIdEnum>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to BqrIdEnum_Name().");
  return BqrIdEnum_Name(static_cast<BqrIdEnum>(value));
}
const std::string& BqrIdEnum_Name(BqrIdEnum value);
...
extern const uint32_t BqrPacketTypeEnum_internal_data_[];
constexpr BqrPacketTypeEnum BqrPacketTypeEnum_MIN = static_cast<BqrPacketTypeEnum>(0);
constexpr BqrPacketTypeEnum BqrPacketTypeEnum_MAX = static_cast<BqrPacketTypeEnum>(28);
constexpr int BqrPacketTypeEnum_ARRAYSIZE = 28 + 1;
const std::string& BqrPacketTypeEnum_Name(BqrPacketTypeEnum value);
template <typename T>
const std::string& BqrPacketTypeEnum_Name(T value) {
  static_assert(std::is_same<T, BqrPacketTypeEnum>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to BqrPacketTypeEnum_Name().");
  return BqrPacketTypeEnum_Name(static_cast<BqrPacketTypeEnum>(value));
}
const std::string& BqrPacketTypeEnum_Name(BqrPacketTypeEnum value);
...
template <>
struct is_proto_enum<::android::bluetooth::hci::CommandEnum> : std::true_type {};
template <>
struct is_proto_enum<::android::bluetooth::hci::EventEnum> : std::true_type {};
template <>
struct is_proto_enum<::android::bluetooth::hci::BleMetaEventEnum> : std::true_type {};
template <>
struct is_proto_enum<::android::bluetooth::hci::StatusEnum> : std::true_type {};
template <>
struct is_proto_enum<::android::bluetooth::hci::BqrIdEnum> : std::true_type {};
template <>
struct is_proto_enum<::android::bluetooth::hci::BqrPacketTypeEnum> : std::true_type {};
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_frameworks_2fproto_5flogging_2fstats_2fenums_2fbluetooth_2fhci_2fenums_2eproto_2epb_2eh
