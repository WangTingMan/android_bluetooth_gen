...
const std::string& CommandEnum_Name(CommandEnum value) {
  ...
  int idx = ::google::protobuf::internal::LookUpEnumName(
      CommandEnum_entries, CommandEnum_entries_by_number, 32,
      value);
...
PROTOBUF_CONSTINIT const uint32_t PairingFailReasonEnum_internal_data_[] = {
    983040u, 288u, 4096u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 1779u, };
bool PairingFailReasonEnum_IsValid(int value) {
  return ::_pbi::ValidateEnum(value, PairingFailReasonEnum_internal_data_);
}
static ::google::protobuf::internal::ExplicitlyConstructed<std::string>
    PairingFailReasonEnum_strings[24] = {};
...
static const ::google::protobuf::internal::EnumEntry PairingFailReasonEnum_entries[] =
    {
...
const std::string& PairingFailReasonEnum_Name(PairingFailReasonEnum value) {
  static const bool kDummy =
      ::google::protobuf::internal::InitializeEnumStrings(
          PairingFailReasonEnum_entries, PairingFailReasonEnum_entries_by_number,
          24, PairingFailReasonEnum_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(
      PairingFailReasonEnum_entries, PairingFailReasonEnum_entries_by_number, 24,
      value);
  return idx == -1 ? ::google::protobuf::internal::GetEmptyString()
