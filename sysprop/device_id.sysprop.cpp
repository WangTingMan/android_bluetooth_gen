...
using namespace android::sysprop::bluetooth::DeviceIDProperties;
...
std::optional<std::int32_t> vendor_id() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.device_id.vendor_id");
}

std::optional<std::int32_t> vendor_id_source() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.device_id.vendor_id_source");
}

std::optional<std::int32_t> product_id() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.device_id.product_id");
}
