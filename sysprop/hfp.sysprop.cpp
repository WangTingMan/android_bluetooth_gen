...
using namespace android::sysprop::bluetooth::Hfp;
...
std::optional<std::int32_t> hf_client_features() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.hfp.hf_client_features.config");
}

std::optional<std::int32_t> hf_features() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.hfp.hf_features.config");
}

std::optional<std::int32_t> hf_services() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.hfp.hf_services_mask.config");
}

std::optional<std::int32_t> version() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.hfp.version.config");
}

std::optional<bool> codec_aptx_voice() {
    return GetProp<std::optional<bool>>("bluetooth.hfp.codec_aptx_voice.enabled");
}
