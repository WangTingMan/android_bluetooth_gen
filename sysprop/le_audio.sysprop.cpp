...
using namespace android::sysprop::bluetooth::LeAudio;
...
std::optional<bool> is_software_datapath_supported_test() {
    return GetProp<std::optional<bool>>("bluetooth.le_audio.software_datapath_test.enabled");
}

std::optional<bool> is_dynamic_direction_opening_supported_test() {
    return GetProp<std::optional<bool>>("bluetooth.le_audio.dynamic_direction_opening_test.enabled");
}

std::optional<bool> iso_interleaved_packing_enabled() {
    return GetProp<std::optional<bool>>("bluetooth.le_audio.iso_interleaved_packing.enabled");
}
