...
using namespace android::sysprop::bluetooth::Tmap;
...
std::optional<bool> isProfileTmapCallGatewayEnabled() {
    return GetProp<std::optional<bool>>("bluetooth.profile.tmap.call_gateway.enabled");
}

std::optional<bool> isProfileTmapUnicastMediaSenderEnabled() {
    return GetProp<std::optional<bool>>("bluetooth.profile.tmap.unicast_media_sender.enabled");
}

std::optional<bool> isProfileTmapBroadcastMediaSenderEnabled() {
    return GetProp<std::optional<bool>>("bluetooth.profile.tmap.broadcast_media_sender.enabled");
}
