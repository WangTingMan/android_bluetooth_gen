...
using namespace android::sysprop::bluetooth::Ble;
...
std::optional<bool> vnd_included() {
    return GetProp<std::optional<bool>>("bluetooth.ble.vnd.included");
}

std::optional<std::int32_t> random_address_rotation_interval_min() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.ble.random_address_rotation_interval_min");
}

std::optional<std::int32_t> random_address_rotation_interval_max() {
    return GetProp<std::optional<std::int32_t>>("bluetooth.ble.random_address_rotation_interval_max");
}
