...
#ifndef FLATBUFFERS_GENERATED_AUDIOSETSCENARIOS_BLUETOOTH_FBS_LE_AUDIO_H_
#define FLATBUFFERS_GENERATED_AUDIOSETSCENARIOS_BLUETOOTH_FBS_LE_AUDIO_H_
...
inline flatbuffers::Offset<AudioSetScenario> CreateAudioSetScenarioDirect(
  ...
  return bluetooth::fbs::le_audio::CreateAudioSetScenario(
      _fbb,
      _comments___,
      name__,
      configurations__);
...
struct AudioSetScenarios FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenario>> *scenarios() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenario>> *>(VT_SCENARIOS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT__COMMENTS_) &&
...
struct AudioSetScenariosBuilder {
  ...
  void add_scenarios(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenario>>> scenarios) {
...
inline flatbuffers::Offset<AudioSetScenarios> CreateAudioSetScenarios(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> _comments_ = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenario>>> scenarios = 0) {
...
inline flatbuffers::Offset<AudioSetScenarios> CreateAudioSetScenariosDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *_comments_ = nullptr,
    std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenario>> *scenarios = nullptr) {
  auto _comments___ = _comments_ ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*_comments_) : 0;
  auto scenarios__ = scenarios ? _fbb.CreateVectorOfSortedTables<bluetooth::fbs::le_audio::AudioSetScenario>(scenarios) : 0;
  return bluetooth::fbs::le_audio::CreateAudioSetScenarios(
      _fbb,
      _comments___,
      scenarios__);
}

inline const bluetooth::fbs::le_audio::AudioSetScenarios *GetAudioSetScenarios(const void *buf) {
  return flatbuffers::GetRoot<bluetooth::fbs::le_audio::AudioSetScenarios>(buf);
}

inline const bluetooth::fbs::le_audio::AudioSetScenarios *GetSizePrefixedAudioSetScenarios(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<bluetooth::fbs::le_audio::AudioSetScenarios>(buf);
}

inline bool VerifyAudioSetScenariosBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<bluetooth::fbs::le_audio::AudioSetScenarios>(nullptr);
}

inline bool VerifySizePrefixedAudioSetScenariosBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<bluetooth::fbs::le_audio::AudioSetScenarios>(nullptr);
}

inline void FinishAudioSetScenariosBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetScenarios> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_AUDIOSETSCENARIOS_BLUETOOTH_FBS_LE_AUDIO_H_
