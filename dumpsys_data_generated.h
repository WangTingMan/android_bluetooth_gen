...
struct DumpsysData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_HCI_CONTROLLER_DUMPSYS_DATA = 16,
    VT_MODULE_UNITTEST_DATA = 18
  };
  ...
  const bluetooth::hci::ControllerData *hci_controller_dumpsys_data() const {
    return GetPointer<const bluetooth::hci::ControllerData *>(VT_HCI_CONTROLLER_DUMPSYS_DATA);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_HCI_CONTROLLER_DUMPSYS_DATA) &&
           verifier.VerifyTable(hci_controller_dumpsys_data()) &&
...
struct DumpsysDataBuilder {
  ...
  void add_hci_controller_dumpsys_data(flatbuffers::Offset<bluetooth::hci::ControllerData> hci_controller_dumpsys_data) {
    fbb_.AddOffset(DumpsysData::VT_HCI_CONTROLLER_DUMPSYS_DATA, hci_controller_dumpsys_data);
  }
...
inline flatbuffers::Offset<DumpsysData> CreateDumpsysData(
    ...
    flatbuffers::Offset<bluetooth::hci::ControllerData> hci_controller_dumpsys_data = 0,
  ...
  builder_.add_hci_controller_dumpsys_data(hci_controller_dumpsys_data);
