...
#ifndef FLATBUFFERS_GENERATED_AUDIOSETCONFIGURATIONS_BLUETOOTH_FBS_LE_AUDIO_H_
#define FLATBUFFERS_GENERATED_AUDIOSETCONFIGURATIONS_BLUETOOTH_FBS_LE_AUDIO_H_
...
inline flatbuffers::Offset<CompoundValue> CreateCompoundValueDirect(
  ...
  return bluetooth::fbs::le_audio::CreateCompoundValue(
      _fbb,
      value__,
      value_width);
}
...
struct CodecSpecificConfiguration FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const bluetooth::fbs::le_audio::CompoundValue *compound_value() const {
    return GetPointer<const bluetooth::fbs::le_audio::CompoundValue *>(VT_COMPOUND_VALUE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct CodecSpecificConfigurationBuilder {
  ...
  void add_compound_value(flatbuffers::Offset<bluetooth::fbs::le_audio::CompoundValue> compound_value) {
...
inline flatbuffers::Offset<CodecSpecificConfiguration> CreateCodecSpecificConfiguration(
    ...
    uint8_t type = 0,
    flatbuffers::Offset<bluetooth::fbs::le_audio::CompoundValue> compound_value = 0) {
...
inline flatbuffers::Offset<CodecSpecificConfiguration> CreateCodecSpecificConfigurationDirect(
  ...
  return bluetooth::fbs::le_audio::CreateCodecSpecificConfiguration(
      _fbb,
      name__,
      type,
      compound_value);
...
struct AudioSetSubConfiguration FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bluetooth::fbs::le_audio::AudioSetConfigurationDirection direction() const {
    return static_cast<bluetooth::fbs::le_audio::AudioSetConfigurationDirection>(GetField<int8_t>(VT_DIRECTION, 1));
  }
  const bluetooth::fbs::le_audio::CodecId *codec_id() const {
    return GetStruct<const bluetooth::fbs::le_audio::CodecId *>(VT_CODEC_ID);
  }
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecSpecificConfiguration>> *codec_configuration() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecSpecificConfiguration>> *>(VT_CODEC_CONFIGURATION);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyFieldRequired<bluetooth::fbs::le_audio::CodecId>(verifier, VT_CODEC_ID, 2) &&
...
struct AudioSetSubConfigurationBuilder {
  ...
  void add_direction(bluetooth::fbs::le_audio::AudioSetConfigurationDirection direction) {
    fbb_.AddElement<int8_t>(AudioSetSubConfiguration::VT_DIRECTION, static_cast<int8_t>(direction), 1);
  }
  void add_codec_id(const bluetooth::fbs::le_audio::CodecId *codec_id) {
    fbb_.AddStruct(AudioSetSubConfiguration::VT_CODEC_ID, codec_id);
  }
  void add_codec_configuration(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecSpecificConfiguration>>> codec_configuration) {
...
inline flatbuffers::Offset<AudioSetSubConfiguration> CreateAudioSetSubConfiguration(
    ...
    uint8_t ase_cnt = 0,
    bluetooth::fbs::le_audio::AudioSetConfigurationDirection direction = bluetooth::fbs::le_audio::AudioSetConfigurationDirection_SINK,
    const bluetooth::fbs::le_audio::CodecId *codec_id = nullptr,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecSpecificConfiguration>>> codec_configuration = 0) {
...
inline flatbuffers::Offset<AudioSetSubConfiguration> CreateAudioSetSubConfigurationDirect(
    ...
    bluetooth::fbs::le_audio::AudioSetConfigurationDirection direction = bluetooth::fbs::le_audio::AudioSetConfigurationDirection_SINK,
    const bluetooth::fbs::le_audio::CodecId *codec_id = nullptr,
    std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecSpecificConfiguration>> *codec_configuration = nullptr) {
  auto codec_configuration__ = codec_configuration ? _fbb.CreateVectorOfSortedTables<bluetooth::fbs::le_audio::CodecSpecificConfiguration>(codec_configuration) : 0;
  return bluetooth::fbs::le_audio::CreateAudioSetSubConfiguration(
      _fbb,
      ase_channel_cnt,
      ase_cnt,
      direction,
...
struct CodecConfiguration FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>> *subconfigurations() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>> *>(VT_SUBCONFIGURATIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct CodecConfigurationBuilder {
  ...
  void add_subconfigurations(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>>> subconfigurations) {
...
inline flatbuffers::Offset<CodecConfiguration> CreateCodecConfiguration(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>>> subconfigurations = 0) {
...
inline flatbuffers::Offset<CodecConfiguration> CreateCodecConfigurationDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const char *name = nullptr,
    const std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>> *subconfigurations = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto subconfigurations__ = subconfigurations ? _fbb.CreateVector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetSubConfiguration>>(*subconfigurations) : 0;
  return bluetooth::fbs::le_audio::CreateCodecConfiguration(
      _fbb,
      name__,
      subconfigurations__);
}
...
struct QosConfiguration FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bluetooth::fbs::le_audio::AudioSetConfigurationTargetLatency target_latency() const {
    return static_cast<bluetooth::fbs::le_audio::AudioSetConfigurationTargetLatency>(GetField<int8_t>(VT_TARGET_LATENCY, 2));
  }
...
struct QosConfigurationBuilder {
  ...
  void add_target_latency(bluetooth::fbs::le_audio::AudioSetConfigurationTargetLatency target_latency) {
...
inline flatbuffers::Offset<QosConfiguration> CreateQosConfiguration(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    bluetooth::fbs::le_audio::AudioSetConfigurationTargetLatency target_latency = bluetooth::fbs::le_audio::AudioSetConfigurationTargetLatency_BALANCED_RELIABILITY,
...
inline flatbuffers::Offset<QosConfiguration> CreateQosConfigurationDirect(
    ...
    uint16_t max_transport_latency = 0) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return bluetooth::fbs::le_audio::CreateQosConfiguration(
      _fbb,
      name__,
      target_latency,
...
inline flatbuffers::Offset<AudioSetConfiguration> CreateAudioSetConfigurationDirect(
  ...
  return bluetooth::fbs::le_audio::CreateAudioSetConfiguration(
      _fbb,
      name__,
      codec_config_name__,
      qos_config_name__);
...
struct AudioSetConfigurations FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfiguration>> *configurations() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfiguration>> *>(VT_CONFIGURATIONS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecConfiguration>> *codec_configurations() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecConfiguration>> *>(VT_CODEC_CONFIGURATIONS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::QosConfiguration>> *qos_configurations() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::QosConfiguration>> *>(VT_QOS_CONFIGURATIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct AudioSetConfigurationsBuilder {
  ...
  void add_configurations(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfiguration>>> configurations) {
    fbb_.AddOffset(AudioSetConfigurations::VT_CONFIGURATIONS, configurations);
  }
  void add_codec_configurations(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecConfiguration>>> codec_configurations) {
    fbb_.AddOffset(AudioSetConfigurations::VT_CODEC_CONFIGURATIONS, codec_configurations);
  }
  void add_qos_configurations(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::QosConfiguration>>> qos_configurations) {
...
inline flatbuffers::Offset<AudioSetConfigurations> CreateAudioSetConfigurations(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfiguration>>> configurations = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecConfiguration>>> codec_configurations = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<bluetooth::fbs::le_audio::QosConfiguration>>> qos_configurations = 0) {
...
inline flatbuffers::Offset<AudioSetConfigurations> CreateAudioSetConfigurationsDirect(
    ...
    std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfiguration>> *configurations = nullptr,
    std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::CodecConfiguration>> *codec_configurations = nullptr,
    std::vector<flatbuffers::Offset<bluetooth::fbs::le_audio::QosConfiguration>> *qos_configurations = nullptr) {
  auto _comments___ = _comments_ ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*_comments_) : 0;
  auto configurations__ = configurations ? _fbb.CreateVectorOfSortedTables<bluetooth::fbs::le_audio::AudioSetConfiguration>(configurations) : 0;
  auto codec_configurations__ = codec_configurations ? _fbb.CreateVectorOfSortedTables<bluetooth::fbs::le_audio::CodecConfiguration>(codec_configurations) : 0;
  auto qos_configurations__ = qos_configurations ? _fbb.CreateVectorOfSortedTables<bluetooth::fbs::le_audio::QosConfiguration>(qos_configurations) : 0;
  return bluetooth::fbs::le_audio::CreateAudioSetConfigurations(
      _fbb,
      _comments___,
      configurations__,
...
inline const bluetooth::fbs::le_audio::AudioSetConfigurations *GetAudioSetConfigurations(const void *buf) {
  return flatbuffers::GetRoot<bluetooth::fbs::le_audio::AudioSetConfigurations>(buf);
}

inline const bluetooth::fbs::le_audio::AudioSetConfigurations *GetSizePrefixedAudioSetConfigurations(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<bluetooth::fbs::le_audio::AudioSetConfigurations>(buf);
}

inline bool VerifyAudioSetConfigurationsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<bluetooth::fbs::le_audio::AudioSetConfigurations>(nullptr);
}

inline bool VerifySizePrefixedAudioSetConfigurationsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<bluetooth::fbs::le_audio::AudioSetConfigurations>(nullptr);
}

inline void FinishAudioSetConfigurationsBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<bluetooth::fbs::le_audio::AudioSetConfigurations> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_AUDIOSETCONFIGURATIONS_BLUETOOTH_FBS_LE_AUDIO_H_
