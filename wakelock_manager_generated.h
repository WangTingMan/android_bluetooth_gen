...
struct WakelockManagerData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_IS_ACQUIRED, 1) &&
           VerifyField<uint8_t>(verifier, VT_IS_NATIVE, 1) &&
           VerifyField<int32_t>(verifier, VT_ACQUIRED_COUNT, 4) &&
           VerifyField<int32_t>(verifier, VT_RELEASED_COUNT, 4) &&
           VerifyField<int32_t>(verifier, VT_ACQUIRED_ERROR_COUNT, 4) &&
           VerifyField<int32_t>(verifier, VT_RELEASED_ERROR_COUNT, 4) &&
           VerifyField<int32_t>(verifier, VT_LAST_ACQUIRE_ERROR_CODE, 4) &&
           VerifyField<int32_t>(verifier, VT_LAST_RELEASE_ERROR_CODE, 4) &&
           VerifyField<int64_t>(verifier, VT_LAST_ACQUIRED_TIMESTAMP_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_LAST_RELEASED_TIMESTAMP_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_LAST_INTERVAL_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_MAX_INTERVAL_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_MIN_INTERVAL_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_AVG_INTERVAL_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_TOTAL_INTERVAL_MILLIS, 8) &&
           VerifyField<int64_t>(verifier, VT_TOTAL_TIME_SINCE_RESET_MILLIS, 8) &&
           verifier.EndTable();
  }
};
