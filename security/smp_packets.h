...
class CommandView : public PacketView<kLittleEndian> { public:static CommandView Create(PacketView<kLittleEndian> packet){ return CommandView(std::move(packet)); }static std::optional<CommandView> CreateOptional(PacketView<kLittleEndian> packet){ auto to_validate = CommandView::Create(std::move(packet));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
bool Validate() const override {
  if (!CommandView::Validate()) {
    return false;
  }
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 6 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_REQUEST) return false;
...
class PairingResponseView : public CommandView { public:static PairingResponseView Create(CommandView parent){ return PairingResponseView(std::move(parent)); }static std::optional<PairingResponseView> CreateOptional(CommandView parent){ auto to_validate = PairingResponseView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 6 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_RESPONSE) return false;
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_CONFIRM) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "PairingConfirm { ";ss << ""  << "confirm_value = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetConfirmValue()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit PairingConfirmView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class PairingRandomView : public CommandView { public:static PairingRandomView Create(CommandView parent){ return PairingRandomView(std::move(parent)); }static std::optional<PairingRandomView> CreateOptional(CommandView parent){ auto to_validate = PairingRandomView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_RANDOM) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "PairingRandom { ";ss << ""  << "random_value = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetRandomValue()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit PairingRandomView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class PairingFailedView : public CommandView { public:static PairingFailedView Create(CommandView parent){ return PairingFailedView(std::move(parent)); }static std::optional<PairingFailedView> CreateOptional(CommandView parent){ auto to_validate = PairingFailedView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 1 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_FAILED) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "PairingFailed { ";ss << ""  << "reason = " << PairingFailedReasonText(GetReason());ss << " }";return ss.str();}

 protected:
explicit PairingFailedView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class EncryptionInformationView : public CommandView { public:static EncryptionInformationView Create(CommandView parent){ return EncryptionInformationView(std::move(parent)); }static std::optional<EncryptionInformationView> CreateOptional(CommandView parent){ auto to_validate = EncryptionInformationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::ENCRYPTION_INFORMATION) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "EncryptionInformation { ";ss << ""  << "long_term_key = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetLongTermKey()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit EncryptionInformationView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class CentralIdentificationView : public CommandView { public:static CentralIdentificationView Create(CommandView parent){ return CentralIdentificationView(std::move(parent)); }static std::optional<CentralIdentificationView> CreateOptional(CommandView parent){ auto to_validate = CentralIdentificationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 10 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::CENTRAL_IDENTIFICATION) return false;

return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "CentralIdentification { ";ss << ""  << "ediv = " << static_cast<uint64_t>(GetEdiv()) << ", rand = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 8; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetRand()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit CentralIdentificationView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class IdentityInformationView : public CommandView { public:static IdentityInformationView Create(CommandView parent){ return IdentityInformationView(std::move(parent)); }static std::optional<IdentityInformationView> CreateOptional(CommandView parent){ auto to_validate = IdentityInformationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::IDENTITY_INFORMATION) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "IdentityInformation { ";ss << ""  << "identity_resolving_key = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetIdentityResolvingKey()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit IdentityInformationView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class IdentityAddressInformationView : public CommandView { public:static IdentityAddressInformationView Create(CommandView parent){ return IdentityAddressInformationView(std::move(parent)); }static std::optional<IdentityAddressInformationView> CreateOptional(CommandView parent){ auto to_validate = IdentityAddressInformationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 7 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::IDENTITY_ADDRESS_INFORMATION) return false;

return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "IdentityAddressInformation { ";ss << ""  << "addr_type = " << AddrTypeText(GetAddrType()) << ", bd_addr = " << GetBdAddr().ToString();ss << " }";return ss.str();}

 protected:
explicit IdentityAddressInformationView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class SigningInformationView : public CommandView { public:static SigningInformationView Create(CommandView parent){ return SigningInformationView(std::move(parent)); }static std::optional<SigningInformationView> CreateOptional(CommandView parent){ auto to_validate = SigningInformationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::SIGNING_INFORMATION) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "SigningInformation { ";ss << ""  << "signature_key = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetSignatureKey()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit SigningInformationView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class SecurityRequestView : public CommandView { public:static SecurityRequestView Create(CommandView parent){ return SecurityRequestView(std::move(parent)); }static std::optional<SecurityRequestView> CreateOptional(CommandView parent){ auto to_validate = SecurityRequestView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 1 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::SECURITY_REQUEST) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "SecurityRequest { ";ss << ""  << "auth_req = " << static_cast<uint64_t>(GetAuthReq());ss << " }";return ss.str();}

 protected:
explicit SecurityRequestView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class PairingPublicKeyView : public CommandView { public:static PairingPublicKeyView Create(CommandView parent){ return PairingPublicKeyView(std::move(parent)); }static std::optional<PairingPublicKeyView> CreateOptional(CommandView parent){ auto to_validate = PairingPublicKeyView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 64 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_PUBLIC_KEY) return false;
...
class PairingDhKeyCheckView : public CommandView { public:static PairingDhKeyCheckView Create(CommandView parent){ return PairingDhKeyCheckView(std::move(parent)); }static std::optional<PairingDhKeyCheckView> CreateOptional(CommandView parent){ auto to_validate = PairingDhKeyCheckView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 16 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_DH_KEY_CHECK) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "PairingDhKeyCheck { ";ss << ""  << "dh_key_check = " << "ARRAY[";/* uint8_t   ScalarField */for (size_t index = 0; index < 16; index++) {ss << ((index == 0) ? "" : ", ") << static_cast<uint64_t>((GetDhKeyCheck()[index]));}ss << "]";ss << " }";return ss.str();}

 protected:
explicit PairingDhKeyCheckView(CommandView parent) : CommandView(std::move(parent)) { was_validated_ = false; }};


class PairingKeypressNotificationView : public CommandView { public:static PairingKeypressNotificationView Create(CommandView parent){ return PairingKeypressNotificationView(std::move(parent)); }static std::optional<PairingKeypressNotificationView> CreateOptional(CommandView parent){ auto to_validate = PairingKeypressNotificationView::Create(std::move(parent));if (to_validate.IsValid()) { return to_validate; }else {return {};}}
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
...
auto it = begin() + (/* Bits: */ 8 + /* Dynamic: */ 0) / 8;it += 1 /* Total size of the fixed fields */;if (it > end()) return false;if (GetCode() != Code::PAIRING_KEYPRESS_NOTIFICATION) return false;
return true;}

 public:virtual std::string ToString() const  override {std::stringstream ss;ss << std::showbase << std::hex << "PairingKeypressNotification { ";ss << ""  << "notification_type = " << KeypressNotificationTypeText(GetNotificationType());ss << " }";return ss.str();}
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CommandBuilder> FromView(CommandView view) {if (!view.IsValid()) return nullptr;return CommandBuilder::Create(view.GetCode(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingRequestBuilder> FromView(PairingRequestView view) {if (!view.IsValid()) return nullptr;return PairingRequestBuilder::Create(view.GetIoCapability(), view.GetOobDataFlag(), view.GetAuthReq(), view.GetMaximumEncryptionKeySize(), view.GetInitiatorKeyDistribution(), view.GetResponderKeyDistribution());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingConfirmBuilder> FromView(PairingConfirmView view) {if (!view.IsValid()) return nullptr;return PairingConfirmBuilder::Create(view.GetConfirmValue());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingRandomBuilder> FromView(PairingRandomView view) {if (!view.IsValid()) return nullptr;return PairingRandomBuilder::Create(view.GetRandomValue());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingFailedBuilder> FromView(PairingFailedView view) {if (!view.IsValid()) return nullptr;return PairingFailedBuilder::Create(view.GetReason());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EncryptionInformationBuilder> FromView(EncryptionInformationView view) {if (!view.IsValid()) return nullptr;return EncryptionInformationBuilder::Create(view.GetLongTermKey());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CentralIdentificationBuilder> FromView(CentralIdentificationView view) {if (!view.IsValid()) return nullptr;return CentralIdentificationBuilder::Create(view.GetEdiv(), view.GetRand());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<IdentityInformationBuilder> FromView(IdentityInformationView view) {if (!view.IsValid()) return nullptr;return IdentityInformationBuilder::Create(view.GetIdentityResolvingKey());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<IdentityAddressInformationBuilder> FromView(IdentityAddressInformationView view) {if (!view.IsValid()) return nullptr;return IdentityAddressInformationBuilder::Create(view.GetAddrType(), view.GetBdAddr());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<SigningInformationBuilder> FromView(SigningInformationView view) {if (!view.IsValid()) return nullptr;return SigningInformationBuilder::Create(view.GetSignatureKey());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<SecurityRequestBuilder> FromView(SecurityRequestView view) {if (!view.IsValid()) return nullptr;return SecurityRequestBuilder::Create(view.GetAuthReq());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingPublicKeyBuilder> FromView(PairingPublicKeyView view) {if (!view.IsValid()) return nullptr;return PairingPublicKeyBuilder::Create(view.GetPublicKeyX(), view.GetPublicKeyY());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingDhKeyCheckBuilder> FromView(PairingDhKeyCheckView view) {if (!view.IsValid()) return nullptr;return PairingDhKeyCheckBuilder::Create(view.GetDhKeyCheck());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<PairingKeypressNotificationBuilder> FromView(PairingKeypressNotificationView view) {if (!view.IsValid()) return nullptr;return PairingKeypressNotificationBuilder::Create(view.GetNotificationType());}
#endif
...
namespace fmt {
template <>
struct formatter<bluetooth::security::Code> : enum_formatter<bluetooth::security::Code> {};
template <>
struct formatter<bluetooth::security::IoCapability> : enum_formatter<bluetooth::security::IoCapability> {};
template <>
struct formatter<bluetooth::security::OobDataFlag> : enum_formatter<bluetooth::security::OobDataFlag> {};
template <>
struct formatter<bluetooth::security::BondingFlags> : enum_formatter<bluetooth::security::BondingFlags> {};
template <>
struct formatter<bluetooth::security::PairingFailedReason> : enum_formatter<bluetooth::security::PairingFailedReason> {};
template <>
struct formatter<bluetooth::security::AddrType> : enum_formatter<bluetooth::security::AddrType> {};
template <>
struct formatter<bluetooth::security::KeypressNotificationType> : enum_formatter<bluetooth::security::KeypressNotificationType> {};
} // namespace fmt
#endif // __has_include(<bluetooth/log.h>)
