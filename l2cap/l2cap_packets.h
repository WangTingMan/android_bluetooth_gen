...
auto it = begin() + (/* Bits: */ 33 + /* Dynamic: */ 0) / 8;it += 2 /* Total size of the fixed fields */;if (it > end()) return false;if (GetFrameType() != FrameType::S_FRAME) return false;if (GetFixedScalar0() != 0) return false;
...
protected:uint8_t GetFixedScalar0() const {ASSERT(was_validated_);auto to_bound = begin();auto fixed_scalar0_it = to_bound + (/* Bits: */ 33 + /* Dynamic: */ 0) / 8;uint8_t fixed_scalar0_value{};uint8_t* fixed_scalar0_ptr = &fixed_scalar0_value;auto extracted_value = fixed_scalar0_it.extract<uint8_t>();extracted_value >>= 1;extracted_value &= 0x1;*fixed_scalar0_ptr = static_cast<uint8_t>(extracted_value);return fixed_scalar0_value;}public:
...
auto it = begin() + (/* Bits: */ 49 + /* Dynamic: */ 0) / 8;it += 2 /* Total size of the fixed fields */;if (it > end()) return false;if (GetFrameType() != FrameType::S_FRAME) return false;if (GetFixedScalar0() != 0) return false;
...
auto it = begin() + (/* Bits: */ 33 + /* Dynamic: */ 0) / 8;it += 2 /* Total size of the fixed fields */;if (it > end()) return false;if (GetFrameType() != FrameType::S_FRAME) return false;if (GetFixedScalar1() != 0) return false;
...
auto it = begin() + (/* Bits: */ 49 + /* Dynamic: */ 0) / 8;it += 2 /* Total size of the fixed fields */;if (it > end()) return false;if (GetFrameType() != FrameType::S_FRAME) return false;if (GetFixedScalar1() != 0) return false;
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<BasicFrameBuilder> FromView(BasicFrameView view) {if (!view.IsValid()) return nullptr;return BasicFrameBuilder::Create(view.GetChannelId(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<BasicFrameWithFcsBuilder> FromView(BasicFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return BasicFrameWithFcsBuilder::Create(view.GetChannelId(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<GroupFrameBuilder> FromView(GroupFrameView view) {if (!view.IsValid()) return nullptr;return GroupFrameBuilder::Create(view.GetPsm(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<StandardSupervisoryFrameBuilder> FromView(StandardSupervisoryFrameView view) {if (!view.IsValid()) return nullptr;return StandardSupervisoryFrameBuilder::Create(view.GetChannelId(), view.GetS(), view.GetR(), view.GetReqSeq());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<StandardSupervisoryFrameWithFcsBuilder> FromView(StandardSupervisoryFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return StandardSupervisoryFrameWithFcsBuilder::Create(view.GetChannelId(), view.GetS(), view.GetR(), view.GetReqSeq());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EnhancedSupervisoryFrameBuilder> FromView(EnhancedSupervisoryFrameView view) {if (!view.IsValid()) return nullptr;return EnhancedSupervisoryFrameBuilder::Create(view.GetChannelId(), view.GetS(), view.GetP(), view.GetF(), view.GetReqSeq());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EnhancedSupervisoryFrameWithFcsBuilder> FromView(EnhancedSupervisoryFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return EnhancedSupervisoryFrameWithFcsBuilder::Create(view.GetChannelId(), view.GetS(), view.GetP(), view.GetF(), view.GetReqSeq());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EnhancedInformationFrameWithFcsBuilder> FromView(EnhancedInformationFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return EnhancedInformationFrameWithFcsBuilder::Create(view.GetChannelId(), view.GetTxSeq(), view.GetF(), view.GetReqSeq(), view.GetSar(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ExtendedSupervisoryFrameBuilder> FromView(ExtendedSupervisoryFrameView view) {if (!view.IsValid()) return nullptr;return ExtendedSupervisoryFrameBuilder::Create(view.GetChannelId(), view.GetF(), view.GetReqSeq(), view.GetS(), view.GetP());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ExtendedSupervisoryFrameWithFcsBuilder> FromView(ExtendedSupervisoryFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return ExtendedSupervisoryFrameWithFcsBuilder::Create(view.GetChannelId(), view.GetF(), view.GetReqSeq(), view.GetS(), view.GetP());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ExtendedInformationFrameBuilder> FromView(ExtendedInformationFrameView view) {if (!view.IsValid()) return nullptr;return ExtendedInformationFrameBuilder::Create(view.GetChannelId(), view.GetF(), view.GetReqSeq(), view.GetSar(), view.GetTxSeq(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ExtendedInformationStartFrameWithFcsBuilder> FromView(ExtendedInformationStartFrameWithFcsView view) {if (!view.IsValid()) return nullptr;return ExtendedInformationStartFrameWithFcsBuilder::Create(view.GetChannelId(), view.GetF(), view.GetReqSeq(), view.GetTxSeq(), view.GetL2capSduLength(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<FirstLeInformationFrameBuilder> FromView(FirstLeInformationFrameView view) {if (!view.IsValid()) return nullptr;return FirstLeInformationFrameBuilder::Create(view.GetChannelId(), view.GetL2capSduLength(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ControlFrameBuilder> FromView(ControlFrameView view) {if (!view.IsValid()) return nullptr;return ControlFrameBuilder::Create(std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ControlBuilder> FromView(ControlView view) {if (!view.IsValid()) return nullptr;return ControlBuilder::Create(view.GetCode(), view.GetIdentifier(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CommandRejectNotUnderstoodBuilder> FromView(CommandRejectNotUnderstoodView view) {if (!view.IsValid()) return nullptr;return CommandRejectNotUnderstoodBuilder::Create(view.GetIdentifier());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CommandRejectMtuExceededBuilder> FromView(CommandRejectMtuExceededView view) {if (!view.IsValid()) return nullptr;return CommandRejectMtuExceededBuilder::Create(view.GetIdentifier(), view.GetActualMtu());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CommandRejectInvalidCidBuilder> FromView(CommandRejectInvalidCidView view) {if (!view.IsValid()) return nullptr;return CommandRejectInvalidCidBuilder::Create(view.GetIdentifier(), view.GetLocalChannel(), view.GetRemoteChannel());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConnectionRequestBuilder> FromView(ConnectionRequestView view) {if (!view.IsValid()) return nullptr;return ConnectionRequestBuilder::Create(view.GetIdentifier(), view.GetPsm(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConnectionResponseBuilder> FromView(ConnectionResponseView view) {if (!view.IsValid()) return nullptr;return ConnectionResponseBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid(), view.GetResult(), view.GetStatus());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConfigurationRequestBuilder> FromView(ConfigurationRequestView view) {if (!view.IsValid()) return nullptr;return ConfigurationRequestBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetContinuation(), view.GetConfig());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConfigurationResponseBuilder> FromView(ConfigurationResponseView view) {if (!view.IsValid()) return nullptr;return ConfigurationResponseBuilder::Create(view.GetIdentifier(), view.GetSourceCid(), view.GetContinuation(), view.GetResult(), view.GetConfig());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<DisconnectionRequestBuilder> FromView(DisconnectionRequestView view) {if (!view.IsValid()) return nullptr;return DisconnectionRequestBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<DisconnectionResponseBuilder> FromView(DisconnectionResponseView view) {if (!view.IsValid()) return nullptr;return DisconnectionResponseBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EchoRequestBuilder> FromView(EchoRequestView view) {if (!view.IsValid()) return nullptr;return EchoRequestBuilder::Create(view.GetIdentifier(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<EchoResponseBuilder> FromView(EchoResponseView view) {if (!view.IsValid()) return nullptr;return EchoResponseBuilder::Create(view.GetIdentifier(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<InformationRequestBuilder> FromView(InformationRequestView view) {if (!view.IsValid()) return nullptr;return InformationRequestBuilder::Create(view.GetIdentifier(), view.GetInfoType());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<InformationResponseConnectionlessMtuBuilder> FromView(InformationResponseConnectionlessMtuView view) {if (!view.IsValid()) return nullptr;return InformationResponseConnectionlessMtuBuilder::Create(view.GetIdentifier(), view.GetResult(), view.GetConnectionlessMtu());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<InformationResponseFixedChannelsBuilder> FromView(InformationResponseFixedChannelsView view) {if (!view.IsValid()) return nullptr;return InformationResponseFixedChannelsBuilder::Create(view.GetIdentifier(), view.GetResult(), view.GetFixedChannels());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreateChannelRequestBuilder> FromView(CreateChannelRequestView view) {if (!view.IsValid()) return nullptr;return CreateChannelRequestBuilder::Create(view.GetIdentifier(), view.GetPsm(), view.GetSourceCid(), view.GetControllerId());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreateChannelResponseBuilder> FromView(CreateChannelResponseView view) {if (!view.IsValid()) return nullptr;return CreateChannelResponseBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid(), view.GetResult(), view.GetStatus());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<MoveChannelRequestBuilder> FromView(MoveChannelRequestView view) {if (!view.IsValid()) return nullptr;return MoveChannelRequestBuilder::Create(view.GetIdentifier(), view.GetInitiatorCid(), view.GetDestControllerId());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<MoveChannelResponseBuilder> FromView(MoveChannelResponseView view) {if (!view.IsValid()) return nullptr;return MoveChannelResponseBuilder::Create(view.GetIdentifier(), view.GetInitiatorCid(), view.GetResult());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<MoveChannelConfirmationRequestBuilder> FromView(MoveChannelConfirmationRequestView view) {if (!view.IsValid()) return nullptr;return MoveChannelConfirmationRequestBuilder::Create(view.GetIdentifier(), view.GetInitiatorCid(), view.GetResult());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<MoveChannelConfirmationResponseBuilder> FromView(MoveChannelConfirmationResponseView view) {if (!view.IsValid()) return nullptr;return MoveChannelConfirmationResponseBuilder::Create(view.GetIdentifier(), view.GetInitiatorCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<FlowControlCreditBuilder> FromView(FlowControlCreditView view) {if (!view.IsValid()) return nullptr;return FlowControlCreditBuilder::Create(view.GetIdentifier(), view.GetCid(), view.GetCredits());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreditBasedConnectionRequestBuilder> FromView(CreditBasedConnectionRequestView view) {if (!view.IsValid()) return nullptr;return CreditBasedConnectionRequestBuilder::Create(view.GetIdentifier(), view.GetSpsm(), view.GetMtu(), view.GetMps(), view.GetInitialCredits(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreditBasedConnectionResponseBuilder> FromView(CreditBasedConnectionResponseView view) {if (!view.IsValid()) return nullptr;return CreditBasedConnectionResponseBuilder::Create(view.GetIdentifier(), view.GetMtu(), view.GetMps(), view.GetInitialCredits(), view.GetResult(), view.GetDestinationCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreditBasedReconfigureRequestBuilder> FromView(CreditBasedReconfigureRequestView view) {if (!view.IsValid()) return nullptr;return CreditBasedReconfigureRequestBuilder::Create(view.GetIdentifier(), view.GetMtu(), view.GetMps(), view.GetDestinationCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<CreditBasedReconfigureResponseBuilder> FromView(CreditBasedReconfigureResponseView view) {if (!view.IsValid()) return nullptr;return CreditBasedReconfigureResponseBuilder::Create(view.GetIdentifier(), view.GetResult());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeControlFrameBuilder> FromView(LeControlFrameView view) {if (!view.IsValid()) return nullptr;return LeControlFrameBuilder::Create(std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeControlBuilder> FromView(LeControlView view) {if (!view.IsValid()) return nullptr;return LeControlBuilder::Create(view.GetCode(), view.GetIdentifier(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCommandRejectBuilder> FromView(LeCommandRejectView view) {if (!view.IsValid()) return nullptr;return LeCommandRejectBuilder::Create(view.GetIdentifier(), view.GetReason(), std::make_unique<RawBuilder>(std::vector<uint8_t>(view.GetPayload().begin(), view.GetPayload().end())));}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCommandRejectNotUnderstoodBuilder> FromView(LeCommandRejectNotUnderstoodView view) {if (!view.IsValid()) return nullptr;return LeCommandRejectNotUnderstoodBuilder::Create(view.GetIdentifier());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCommandRejectMtuExceededBuilder> FromView(LeCommandRejectMtuExceededView view) {if (!view.IsValid()) return nullptr;return LeCommandRejectMtuExceededBuilder::Create(view.GetIdentifier(), view.GetActualMtu());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCommandRejectInvalidCidBuilder> FromView(LeCommandRejectInvalidCidView view) {if (!view.IsValid()) return nullptr;return LeCommandRejectInvalidCidBuilder::Create(view.GetIdentifier(), view.GetLocalChannel(), view.GetRemoteChannel());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeDisconnectionRequestBuilder> FromView(LeDisconnectionRequestView view) {if (!view.IsValid()) return nullptr;return LeDisconnectionRequestBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeDisconnectionResponseBuilder> FromView(LeDisconnectionResponseView view) {if (!view.IsValid()) return nullptr;return LeDisconnectionResponseBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetSourceCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConnectionParameterUpdateRequestBuilder> FromView(ConnectionParameterUpdateRequestView view) {if (!view.IsValid()) return nullptr;return ConnectionParameterUpdateRequestBuilder::Create(view.GetIdentifier(), view.GetIntervalMin(), view.GetIntervalMax(), view.GetPeripheralLatency(), view.GetTimeoutMultiplier());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<ConnectionParameterUpdateResponseBuilder> FromView(ConnectionParameterUpdateResponseView view) {if (!view.IsValid()) return nullptr;return ConnectionParameterUpdateResponseBuilder::Create(view.GetIdentifier(), view.GetResult());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCreditBasedConnectionRequestBuilder> FromView(LeCreditBasedConnectionRequestView view) {if (!view.IsValid()) return nullptr;return LeCreditBasedConnectionRequestBuilder::Create(view.GetIdentifier(), view.GetLePsm(), view.GetSourceCid(), view.GetMtu(), view.GetMps(), view.GetInitialCredits());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeCreditBasedConnectionResponseBuilder> FromView(LeCreditBasedConnectionResponseView view) {if (!view.IsValid()) return nullptr;return LeCreditBasedConnectionResponseBuilder::Create(view.GetIdentifier(), view.GetDestinationCid(), view.GetMtu(), view.GetMps(), view.GetInitialCredits(), view.GetResult());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeFlowControlCreditBuilder> FromView(LeFlowControlCreditView view) {if (!view.IsValid()) return nullptr;return LeFlowControlCreditBuilder::Create(view.GetIdentifier(), view.GetCid(), view.GetCredits());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeEnhancedCreditBasedReconfigureRequestBuilder> FromView(LeEnhancedCreditBasedReconfigureRequestView view) {if (!view.IsValid()) return nullptr;return LeEnhancedCreditBasedReconfigureRequestBuilder::Create(view.GetIdentifier(), view.GetMtu(), view.GetMps(), view.GetDestinationCid());}
#endif
...
#if defined(PACKET_FUZZ_TESTING) || defined(PACKET_TESTING) || defined(FUZZ_TARGET)
static std::unique_ptr<LeEnhancedCreditBasedReconfigureResponseBuilder> FromView(LeEnhancedCreditBasedReconfigureResponseView view) {if (!view.IsValid()) return nullptr;return LeEnhancedCreditBasedReconfigureResponseBuilder::Create(view.GetIdentifier(), view.GetResult());}
#endif
...
namespace fmt {
template <>
struct formatter<bluetooth::l2cap::Continuation> : enum_formatter<bluetooth::l2cap::Continuation> {};
template <>
struct formatter<bluetooth::l2cap::FrameType> : enum_formatter<bluetooth::l2cap::FrameType> {};
template <>
struct formatter<bluetooth::l2cap::SupervisoryFunction> : enum_formatter<bluetooth::l2cap::SupervisoryFunction> {};
template <>
struct formatter<bluetooth::l2cap::RetransmissionDisable> : enum_formatter<bluetooth::l2cap::RetransmissionDisable> {};
template <>
struct formatter<bluetooth::l2cap::SegmentationAndReassembly> : enum_formatter<bluetooth::l2cap::SegmentationAndReassembly> {};
template <>
struct formatter<bluetooth::l2cap::Poll> : enum_formatter<bluetooth::l2cap::Poll> {};
template <>
struct formatter<bluetooth::l2cap::Final> : enum_formatter<bluetooth::l2cap::Final> {};
template <>
struct formatter<bluetooth::l2cap::CommandCode> : enum_formatter<bluetooth::l2cap::CommandCode> {};
template <>
struct formatter<bluetooth::l2cap::CommandRejectReason> : enum_formatter<bluetooth::l2cap::CommandRejectReason> {};
template <>
struct formatter<bluetooth::l2cap::ConnectionResponseResult> : enum_formatter<bluetooth::l2cap::ConnectionResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::ConnectionResponseStatus> : enum_formatter<bluetooth::l2cap::ConnectionResponseStatus> {};
template <>
struct formatter<bluetooth::l2cap::ConfigurationOptionType> : enum_formatter<bluetooth::l2cap::ConfigurationOptionType> {};
template <>
struct formatter<bluetooth::l2cap::ConfigurationOptionIsHint> : enum_formatter<bluetooth::l2cap::ConfigurationOptionIsHint> {};
template <>
struct formatter<bluetooth::l2cap::QosServiceType> : enum_formatter<bluetooth::l2cap::QosServiceType> {};
template <>
struct formatter<bluetooth::l2cap::RetransmissionAndFlowControlModeOption> : enum_formatter<bluetooth::l2cap::RetransmissionAndFlowControlModeOption> {};
template <>
struct formatter<bluetooth::l2cap::FcsType> : enum_formatter<bluetooth::l2cap::FcsType> {};
template <>
struct formatter<bluetooth::l2cap::ConfigurationResponseResult> : enum_formatter<bluetooth::l2cap::ConfigurationResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::InformationRequestInfoType> : enum_formatter<bluetooth::l2cap::InformationRequestInfoType> {};
template <>
struct formatter<bluetooth::l2cap::InformationRequestResult> : enum_formatter<bluetooth::l2cap::InformationRequestResult> {};
template <>
struct formatter<bluetooth::l2cap::CreateChannelResponseResult> : enum_formatter<bluetooth::l2cap::CreateChannelResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::CreateChannelResponseStatus> : enum_formatter<bluetooth::l2cap::CreateChannelResponseStatus> {};
template <>
struct formatter<bluetooth::l2cap::MoveChannelResponseResult> : enum_formatter<bluetooth::l2cap::MoveChannelResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::MoveChannelConfirmationResult> : enum_formatter<bluetooth::l2cap::MoveChannelConfirmationResult> {};
template <>
struct formatter<bluetooth::l2cap::CreditBasedConnectionResponseResult> : enum_formatter<bluetooth::l2cap::CreditBasedConnectionResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::CreditBasedReconfigureResponseResult> : enum_formatter<bluetooth::l2cap::CreditBasedReconfigureResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::LeCommandCode> : enum_formatter<bluetooth::l2cap::LeCommandCode> {};
template <>
struct formatter<bluetooth::l2cap::ConnectionParameterUpdateResponseResult> : enum_formatter<bluetooth::l2cap::ConnectionParameterUpdateResponseResult> {};
template <>
struct formatter<bluetooth::l2cap::LeCreditBasedConnectionResponseResult> : enum_formatter<bluetooth::l2cap::LeCreditBasedConnectionResponseResult> {};
} // namespace fmt
#endif // __has_include(<bluetooth/log.h>)
